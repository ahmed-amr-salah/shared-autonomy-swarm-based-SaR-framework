...
#def create_DB():
    ...
    # create_hello_world_digital_twin_table = """
    #     CREATE TABLE IF NOT EXISTS `hello_world_digital_twin_table` (
    #         `col_1` date_type1,
    #         `col_2` date_type2,
    #         `col_3` date_type3,
    #         PRIMARY KEY (key) 
    #     )
    # """
    # cursor.execute(create_hello_world_digital_twin_table)
    # #Create the rest of the tables in the same way 

#def insert_data():
    # cursor = connections["default"].cursor()
    # sql_statement = f"""INSERT INTO  `hello_world_digital_twin_table`
    #             ( `time`,
    #             `value`)
    #             VALUES
    #             (%s,%s,%s), (%s,%s,%s);
